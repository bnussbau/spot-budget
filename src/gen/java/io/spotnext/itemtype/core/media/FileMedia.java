...
public class FileMedia extends Media {
     ...
     * The file path to the data object.
     */
    @Accessor(propertyName = "dataPath", type = io.spotnext.infrastructure.type.AccessorType.get)
     ...
     * The file path to the data object.
     */
    @Accessor(propertyName = "dataPath", type = io.spotnext.infrastructure.type.AccessorType.set)
