...
public abstract class AbstractMedia extends CatalogItem {
     ...
     * The mime type of the content.
     */
    @Accessor(propertyName = "mimeType", type = io.spotnext.infrastructure.type.AccessorType.get)
     ...
     * The mime type of the content.
     */
    @Accessor(propertyName = "mimeType", type = io.spotnext.infrastructure.type.AccessorType.set)
     ...
     * The encoding of the content, eg. "UTF-8" or "base64".
     */
    @Accessor(propertyName = "encoding", type = io.spotnext.infrastructure.type.AccessorType.get)
     ...
     * The encoding of the content, eg. "UTF-8" or "base64".
     */
    @Accessor(propertyName = "encoding", type = io.spotnext.infrastructure.type.AccessorType.set)
