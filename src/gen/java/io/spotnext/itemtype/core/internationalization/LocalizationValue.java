...
public class LocalizationValue extends UniqueIdItem {
     ...
     * The localized value of the key.
     */
    @Accessor(propertyName = "value", type = io.spotnext.infrastructure.type.AccessorType.get)
     ...
     * The localized value of the key.
     */
    @Accessor(propertyName = "value", type = io.spotnext.infrastructure.type.AccessorType.set)
     ...
     * The locale of the translation key.
     */
    @Accessor(propertyName = "locale", type = io.spotnext.infrastructure.type.AccessorType.get)
     ...
     * The locale of the translation key.
     */
    @Accessor(propertyName = "locale", type = io.spotnext.infrastructure.type.AccessorType.set)
